...
public class MapsActivityBibliotheque extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AutocompleteSupportFragment autocompleteFragment = (AutocompleteSupportFragment) getSupportFragmentManager().findFragmentById(R.id.autocomplete_fragment2);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btnLocalisation = findViewById(R.id.btnLocalisation2);
        btnLocalisation2 = findViewById(R.id.btnItineraire2);
        ...
        btnLocalisation2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(lastKnownLocation!=null && destination !=null){
                    ...
                    Toast.makeText(MapsActivityBibliotheque.this,"Veuillez choisir une destination/indiquer votre position",Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.btnLocalisation2) {
            showCurrentPlace();
        }
        return true;
    }
            ...
            placeResult.addOnCompleteListener (new OnCompleteListener<FindCurrentPlaceResponse>() {
                ...
                public void onComplete(@NonNull Task<FindCurrentPlaceResponse> task) {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        MapsActivityBibliotheque.this.openPlacesDialog();
                    }
                    else {
                        Log.e(TAG, "Exception: %s", task.getException());
                    }
    ...
    private void openPlacesDialog() {
        Toast.makeText(MapsActivityBibliotheque.this,"Choissisez l'endroit où vous vous situez s'il est présent dans la liste",Toast.LENGTH_LONG).show();
    ...
    public void traceRoute() {
        ...
        if (start != null && destination != null) {
            ...
            Toast.makeText(MapsActivityBibliotheque.this,"Erreur lors du tracage de l'itinéraire",Toast.LENGTH_LONG).show();
        }
    }
